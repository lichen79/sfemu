...
///
/// [`trap`] takes the last three unclaimed rows of the `0100 1110` line —
/// `4E40`-`4E4F` (`TRAP #n`), `4E73` (`RTE`) and `4E76` (`TRAPV`) — alongside
/// [`system`]'s `4E70`/`4E72` and [`branch`]'s `4E75`/`4E77`/`4E80`-`4EFF`.
///
